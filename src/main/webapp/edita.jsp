                ...
                <form method="post" action="ContatoController?query=editar" enctype="multipart/form-data">  
                    <div class="col s6">
                        ...
                        <div class="input-field col s12">
                            ...
                            <input name="nome" id="nome" type="text" class="validate" required maxlength="30" value="${requestScope.contato.nome}">
                        ...
                        <div class="input-field col s12">
                            ...
                            <input name="email" id="email" type="email" class="validate" required maxlength="40" value="${requestScope.contato.email}">
